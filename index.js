...
emailExistence.check('joy255555tariqisinshallawininthisyea2025@pixmatech.com', function(error, response){
  if (error) {
...
verifier.verify( 'joy255555tariqisinshallawininthisyea2025@pixmatech.com', function( err, info ){
