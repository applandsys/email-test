...
emailExistence.check('joyto343434tariqisinshallawin@live.com', function(error, response){
  if (error) {
...
verifier.verify( 'joyto343434tariqisinshallawin@live.com', function( err, info ){
